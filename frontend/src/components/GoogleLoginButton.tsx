  ...
  if (!isConfigured) {
    return (
      <button
        ...
        className="w-full flex items-center justify-center gap-3 bg-white dark:bg-[#2A1D15] border border-peach-300 dark:border-warmbrown-700 hover:bg-peach-50 dark:hover:bg-warmbrown-800 text-warmbrown-800 dark:text-peach-100 font-bold py-2.5 px-4 rounded-xl shadow-xs hover:shadow-md transition-all text-xs cursor-pointer"
        title="Sign in with Google (Configuration Required)"
      >
