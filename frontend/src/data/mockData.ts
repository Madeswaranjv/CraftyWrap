...
export const FAQS = [
  {
    ...
    sideTitle: 'SHIPPING & DISPATCH',
    sideDetails: 'In-Stock: 1–2 Days • Custom Orders: 3–5 Days • Pan-India Express Delivery with live SMS & WhatsApp tracking.',
  ...
  },
  {
    ...
    sideTitle: 'CUSTOM WORKSHOP',
    sideDetails: 'Custom Palette Matching • Photo References • Size Adjustments • Custom Tag Inscriptions.',
    actionText: 'Start Custom Request',
  ...
  },
  {
    ...
    sideTitle: 'SAFETY & MATERIALS',
    sideDetails: '100% Hypoallergenic Yarn • Child-Safe Locked Eyes • Non-Toxic Dyes • Baby-Safe Options.',
    actionText: 'Chat with Maker',
    actionHref: 'https://wa.me/?text=Hi%20CraftyWrap,%20I%20have%20a%20question%20about%20materials',
  },
  {
    ...
    sideTitle: 'CARE & LONGEVITY',
    sideDetails: 'Cold Water Spot Clean • Mesh Bag Wash • Flat Shade Air-Drying • Maintains plush shape for years.',
    actionText: 'Care Guidelines',
    actionHref: '/contact',
  },
  {
    question: 'Do you offer gift packaging with personalized notes?',
    answer: 'Every order arrives nestled in a padded keepsake gift box with signature wax-stamped tags, an artisan birth certificate, and a handwritten personalized gift card included complimentary.',
    sideTitle: 'GIFT EXPERIENCE',
    sideDetails: 'Padded Keepsake Box • Wax-Sealed Notes • Artisan Birth Tag • Ready to unwrap immediately.',
    actionText: 'Browse Gift Dolls',
    actionHref: '/collections',
  },
  {
    question: 'What payment methods and checkout options do you support?',
    answer: 'We accept UPI (Google Pay, PhonePe, Paytm), all major credit & debit cards, and net banking via secure Razorpay checkout with instantaneous order confirmation.',
    sideTitle: 'SECURE PAYMENTS',
    sideDetails: 'UPI & Major Cards • Razorpay 256-Bit SSL • Instant Confirmation • Zero Hidden Fees.',
